...
export async function createMemberExport({ scope, memberIds, surveyId, baseUrl, membershipStatus = '', excludeTurufjellAsOptOut = true }) {
  ...
  const members = await sql`
    SELECT m.h_number, m.cadastral_number, m.section_number, m.street_address,
      ...
      m.primary_contact_email, m.other_contact_emails, m.turufjell_as_sharing_opt_out,
      EXISTS (
