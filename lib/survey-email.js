...
import { isSurveyEmailBackgroundConfigured } from './survey-email-background.js';
...
export async function getSurveyEmailOverview(surveyId, requestedPage = 1, requestedGroupId = null) {
  ...
  return {
    configured: isMailerSendConfigured(), background_configured: isSurveyEmailBackgroundConfigured(),
