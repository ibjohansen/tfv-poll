...
export function isPublicPath(pathname) {
  return pathname === '/' || pathname === '/admin/login' ||
    ...
    pathname === '/survey' || pathname === '/survey/api/responses' || pathname.startsWith('/api/survey/files/') ||
    pathname === '/api/usage/pageview' || pathname === '/api/locale' ||
    ...
    /^\/carousel\/(?:optimized\/)?[^/?#]+_tf[0-9]+\.(?:jpe?g|png|webp|avif)$/i.test(pathname) ||
