export const AUDITED_TABLES = ['members', 'member_requests', 'member_profile_updates', 'surveys', 'survey_responses', 'survey_attachments', 'cms_pages', 'cms_attachments', 'admin_actions', 'email_campaigns', 'email_deliveries', 'newsletter_campaigns'];
