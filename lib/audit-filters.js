export const AUDITED_TABLES = ['members', 'member_annual_fees', 'member_requests', 'member_profile_updates', 'surveys', 'survey_responses', 'survey_attachments', 'cms_pages', 'cms_attachments', 'accounting_years', 'accounting_expenses', 'accounting_attachments', 'admin_actions', 'email_campaigns', 'email_deliveries', 'newsletter_campaigns', 'email_events'];
export const AUDIT_SOURCES = ['public', 'admin', 'system'];
...
export function normalizeAuditFilters(input = {}) {
  ...
  return {
    q: text(input.q, 200), source: AUDIT_SOURCES.includes(input.source) ? input.source : '',
