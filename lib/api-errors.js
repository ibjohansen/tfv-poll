const validationErrors = new Set([
  ...
  'Invalid member selection', 'No members selected', 'Cadastral number required',
...
const missingErrors = new Set(['Member not found', 'Member request not found', 'Survey not found', 'Page not found', 'File not found', 'Attachment not found', 'Run not found', 'Item not found']);
const conflictErrors = new Set(['Mock data cannot be changed', 'Mock data cannot be exported', 'Too many attachments', 'Sync already running', 'Run already finished', 'Run still active', 'Member request conflict', 'Member request property unresolved', 'Ownership request already pending', 'Survey not sendable', 'No recipients']);
