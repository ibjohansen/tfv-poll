...
test('landing, published CMS paths, survey, auth and explicit assets can reach public handlers', () => {
 ...
 for (const path of ['/admin', '/admin/members', '/api/admin/member-requests/abc', '/api/members', '/api/usage/other', '/future/private', '/future-page.pdf', '/api/responses', '/survey/private', '/survey/api/future', '/dokumenter/private.pdf', '/_next/data/private.json', '/carousel/private.jpg', '/carousel/nested/Ib_tf1.jpg']) assert.equal(isPublicPath(path), false, path);
});
