...
export default async function BrowserFixtures() {
  ...
  return <main className="admin-main"><h1>Isolerte komponenttester</h1>
    ...
    <AdminAuditLog filters={{ q: 'Syntetisk', source: '', table: '', operation: '', status: '', from: '', to: '' }} tables={['members', 'email_events']} data={{ page: 1, pageSize: 50, total: 51, entries: [{ id: 'audit:7001', table_name: 'members', row_id: '7001', operation: 'UPDATE', changed_by: 'admin@example.invalid', changed_at: '2026-09-15T12:00:00Z',
      before_value: { primary_contact_name: 'Syntetisk før' }, after_value: { primary_contact_name: '<script>Syntetisk etter</script>' } },
      { id: 'audit:7002', table_name: 'email_events', row_id: 'synthetic-error', operation: 'INSERT', changed_by: 'system:mailersend', changed_at: '2026-09-15T12:30:00Z', after_value: {
        action: 'email_send_failed', error_id: 'synthetic-error', http_status: 422, provider_message: 'Syntetisk: sender domain not verified', provider_code: 'MS42201', request_id: 'request-synthetic-1',
      } },
    ] }} />
