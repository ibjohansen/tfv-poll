...
export default async function BrowserFixtures() {
  ...
  return <main className="admin-main"><h1>Isolerte komponenttester</h1>
    ...
    <AdminAuditLog filters={{ q: 'Syntetisk', source: '', table: '', operation: '', status: '', from: '', to: '' }} tables={['members']} data={{ page: 1, pageSize: 50, total: 51, entries: [{ id: 'audit:7001', table_name: 'members', row_id: '7001', operation: 'UPDATE', changed_by: 'admin@example.invalid', changed_at: '2026-09-15T12:00:00Z',
